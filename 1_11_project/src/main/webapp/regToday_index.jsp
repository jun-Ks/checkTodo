    	   ...
    	   const xhr = new XMLHttpRequest();
	   		...
	   		xhr.onload = function() {
	   			...
	   			for(let i = 0; i < obj.length; i++){
	   				if(obj[i].state == 0){
	   					content_root.innerHTML += "<div>" +obj[i].list+ "</div>";
	   				}else if(obj[i].state == 1){
	   					content_root.innerHTML += "<div style='text-decoration: line-through; text-decoration-color: lightcoral;'>" +obj[i].list+ "</div>";
	   				}
	   			}
	   		}
